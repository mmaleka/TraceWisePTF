...
class Banding(models.Model):
    ...
    pressure = models.DecimalField(max_digits=7, decimal_places=5)
    gap = models.DecimalField(max_digits=7, decimal_places=5)
    diameter = models.DecimalField(max_digits=7, decimal_places=5)
